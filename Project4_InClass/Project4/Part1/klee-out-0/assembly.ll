...
entry:
  ...
  %0 = call i32 (...)* @klee_make_symbolic([30 x i8]* %a, i64 30, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !149
  %1 = call i32 (...)* @klee_make_symbolic([20 x i8]* %b, i64 20, i8* getelementptr inbounds ([2 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !151
  %a1 = bitcast [30 x i8]* %a to i8*, !dbg !152
...
!1 = metadata !{i32 589865, metadata !"kmp.c", metadata !"/home/peter/Downloads/TopSin/Project4_InClass/Project4/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"kmp.c", metadata !"/home/peter/Downloads/TopSin/Project4_InClass/Project4/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_comp
...
!152 = metadata !{i32 47, i32 0, metadata !150, null}
!153 = metadata !{i32 48, i32 0, metadata !150, null}
